...
2. **P1 设计方法与编程工具（Approach & tooling）**：采用的架构/模式、语言/框架与既有工具链/工程化约束。
...
- **P1 设计方法、编程工具**
  ...
  - 技术栈与工具约束是什么（语言/框架版本、是否允许编辑器/开发工具变更等）？
- **P2 核心设计思路**
...
**P1 设计方法、编程工具**
- 希望采用的设计方法或模式是什么？
- 技术栈与工具约束是什么（语言/框架、工程化工具链、是否允许编辑器/开发工具变更等）？

**P2 核心设计思路**
- 核心抽象与模块边界期望是什么？关键数据流或生命周期怎么走？

**P3 是否允许修改**（请逐项回复是否允许）
- 产品/业务运行时代码（业务逻辑与功能代码）：
